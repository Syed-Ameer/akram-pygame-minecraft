    ...
    for col in range(GRID_WIDTH):
        ...
        if current_lake_width > 0:
            ...
            if lake_started: 
                ...
                spawn_narwhal_y = (water_surface_row + 2) * BLOCK_SIZE  # Spawn 2 blocks into the water
                narwhal = Narwhal(spawn_narwhal_x, spawn_narwhal_y)
                mobs.add(narwhal)
                narwhals_spawned += 1
                print(f"Narwhal spawned at column {col}, total narwhals: {narwhals_spawned}")  # Debug
