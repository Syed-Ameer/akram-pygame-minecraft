...
class Camel(Mob):
    ...
    def __init__(self, x, y):
        ...
        # Drawing - simple camel shape
        self.image.fill((0, 0, 0, 0))
        # Body
        pygame.draw.rect(self.image, (193, 154, 107), (5, int(BLOCK_SIZE * 0.5), int(BLOCK_SIZE * 1.2) - 10, int(BLOCK_SIZE * 0.8)))
        # Hump
        pygame.draw.ellipse(self.image, (180, 140, 90), (int(BLOCK_SIZE * 0.4), int(BLOCK_SIZE * 0.2), int(BLOCK_SIZE * 0.5), int(BLOCK_SIZE * 0.5)))
        # Head/Neck
        pygame.draw.rect(self.image, (193, 154, 107), (int(BLOCK_SIZE * 0.9), int(BLOCK_SIZE * 0.1), int(BLOCK_SIZE * 0.2), int(BLOCK_SIZE * 0.5)))
